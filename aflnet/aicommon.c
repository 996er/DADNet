...
u32 adaptive_online_enable                  = 1;
u32 adaptive_gate_enable                    = 1;
u32 adaptive_cooldown_enable                = 1;
...
void parse_config(){
    ...
    adaptive_online_enable = get_u32_config_or_default("adaptive online enable", info, lines, adaptive_online_enable);
    adaptive_gate_enable = get_u32_config_or_default("adaptive gate enable", info, lines, adaptive_gate_enable);
    adaptive_cooldown_enable = get_u32_config_or_default("adaptive cooldown enable", info, lines, adaptive_cooldown_enable);
